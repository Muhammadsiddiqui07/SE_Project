...
import { LayoutDashboard, BookOpen, FileText, LogOut, Menu, X, GraduationCap, Clock, Award } from 'lucide-react';
...
const DashLayout = () => {
    ...
    useEffect(() => {
        // If we have user from AuthContext, use it. Otherwise fallback to fetching from firebase based on localStorage uid
        if (user && user.name) {
